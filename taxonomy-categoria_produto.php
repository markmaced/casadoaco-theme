...
<section class="w-full py-16">
    <div class="max-w-6xl mx-auto flex md:flex-row flex-col md:gap-10 px-5 md:px-0">
        ...
        <div class="md:w-4/5 w-full">
            <?php
            // Pega o termo atual da taxonomia
            $term = get_queried_object();
            $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;

            // Modifica a consulta para filtrar produtos pela categoria atual
            $args = array(
                'post_type' => 'produtos',
                'posts_per_page' => 12,
                'paged' => $paged,
                'tax_query' => array(
                    array(
                        ...
                        'field' => 'slug',
                        'terms' => $term->slug, // Filtra pela categoria atual
                    ),
                ),
            );
            ...
            <div class="max-w-6xl mx-auto">
                ...
                <?php else: ?>
                    <p class="text-center text-gray-500">Nenhum produto encontrado nesta categoria.</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
