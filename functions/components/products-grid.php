            ...
            <?php if ($query->have_posts()): ?>
                <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    <?php while ($query->have_posts()):
                        $query->the_post(); ?>
                        <div class="w-full flex flex-col justify-between min-h-[400px]" data-aos="zoom-in-right">
                            ...
                            <div class="mt-auto">
                                <a href="<?php the_permalink(); ?>"
                                    class="block text-center bg-casadoaco-orange text-white text-sm font-semibold px-4 py-2 rounded hover:bg-black transition md:w-2/5">Saiba
                                    mais</a>
                            </div>
                        </div>
